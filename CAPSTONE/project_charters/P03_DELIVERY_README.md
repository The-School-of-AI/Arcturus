...
E           AssertionError: Missing section ## 1. Scope Delivered in CAPSTONE/project_charters/P03_DELIVERY_README.md
E           assert '## 1. Scope Delivered' in ''

tests/acceptance/p03_spark/test_structured_page_not_text_wall.py:57: AssertionError
...
tests/integration/test_spark_oracle_data_pipeline.py:37: AssertionError
=============================== warnings summary ===============================
...
FAILED tests/acceptance/p03_spark/test_structured_page_not_text_wall.py::test_07_delivery_readme_has_required_sections
...
FAILED tests/integration/test_spark_oracle_data_pipeline.py::test_04_project_ci_check_is_wired_in_workflow
4 failed, 72 passed, 2 skipped, 3 warnings in 37.17s
- TODO
...
## 10. Demo Steps
- Script: [p03_spark] demo scaffold
Implement full end-to-end demo for P03.
Acceptance contract: tests/acceptance/p03_spark/test_structured_page_not_text_wall.py
Integration contract: tests/integration/test_spark_oracle_data_pipeline.py
- TODO
