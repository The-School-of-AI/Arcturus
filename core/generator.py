...
class AppGenerator:
    ...
    async def generate_frontend(self, prompt: str, model_override: str | None = None) -> dict[str, Any]:
    ...
    async def generate_backend(self, prompt: str, frontend_spec: dict[str, Any], model_override: str | None = None) -> str:
        """Generate Python backend code."""
        print("[Generator] Generating Backend...")
    ...
    async def generate_app(self, name: str, prompt: str, model_override: str | None = None) -> dict[str, Any]:
