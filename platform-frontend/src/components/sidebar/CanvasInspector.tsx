        ...
        return (
            <div className="h-full flex flex-col items-center justify-center p-8 text-center space-y-4 opacity-50">
                ...
                <div className="space-y-1">
                    <h3 className="font-bold text-foreground uppercase tracking-tight">Widget Inspector</h3>
        ...
        <div className="flex flex-col h-full bg-transparent text-foreground">
            ...
            <div className="px-2 py-4 border-b border-border/50 bg-muted/20">
                <div className="flex items-center justify-between mb-1">
                    <span className="text-xs font-bold uppercase tracking-wide text-primary flex items-center gap-2">
            ...
            <div className="flex-1 overflow-y-auto px-2 py-4 space-y-6 scrollbar-hide">
                <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                        <div className="flex justify-between items-center text-xs">
                            ...
                            <span className="font-mono text-xs bg-muted px-1.5 py-0.5 rounded">{activeSurfaceId}</span>
                        </div>
                        <div className="flex justify-between items-center text-xs">
                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-2 pb-2 border-b border-border/30">
                        ...
                        <span className="text-xs font-bold uppercase tracking-wide text-muted-foreground">Live Logs</span>
                    </div>
            ...
            <div className="px-2 py-4 mt-auto border-t border-border/30 bg-muted/5">
                <Button
                    ...
                    disabled={committing}
                    className={cn(
                        "w-full font-bold uppercase h-10 shadow-sm transition-all",
