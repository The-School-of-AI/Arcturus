...
const NavIcon = ({ icon: Icon, label, tab, active, onClick }: {
    ...
    const isInspectorOpen = React.useMemo(() => {
        ...
        return false;
    }, [sidebarTab, selectedNodeId, selectedAppCardId, selectedExplorerNodeId, ragActiveDocumentId, selectedMcpServer, selectedRagFile, showNewsChatPanel, selectedCanvasWidgetId]);
