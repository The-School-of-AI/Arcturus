...
import {
    ...
    CalendarClock, Terminal, Zap, Wand2, Shield, FolderOpen
} from 'lucide-react';
...
const NavIcon = ({ icon: Icon, label, tab, active, onClick }: {
    icon: any,
    label: string,
    tab?: 'runs' | 'spaces' | 'rag' | 'notes' | 'mcp' | 'remme' | 'explorer' | 'apps' | 'news' | 'learn' | 'settings' | 'ide' | 'scheduler' | 'console' | 'skills' | 'canvas' | 'studio' | 'admin',
    active: boolean,
    onClick: () => void
}) => {
