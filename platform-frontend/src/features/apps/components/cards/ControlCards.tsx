    ...
    return (
        <div className="p-3 h-full flex flex-col justify-center gap-2">
            ...
            <div className="relative">
                <select
                    className="w-full bg-muted border border-border rounded px-2 py-1.5 text-xs text-foreground appearance-none focus:outline-none disabled:opacity-50"
                    value={defaultValue}
...
export const TagsInputCard: React.FC<ControlCardProps> = ({ label = "Tags", data = {}, config = {} }) => {
    ...
    return (
        <div className="p-3 h-full flex flex-col gap-2">
            ...
            <Input className="h-7 text-xs bg-muted border-border" placeholder="Add tag..." />
        </div>
    );
};
