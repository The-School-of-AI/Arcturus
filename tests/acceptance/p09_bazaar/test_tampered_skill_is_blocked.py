"""Acceptance scaffold for P09 (p09_bazaar).
...
DEMO_SCRIPT = Path("scripts/demos/p09_bazaar.sh")
THIS_FILE = Path("tests/acceptance/p09_bazaar/test_tampered_skill_is_blocked.py")
