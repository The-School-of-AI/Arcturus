"""Acceptance scaffold for P11 (p11_mnemo).
...
DELIVERY_README = Path("CAPSTONE/project_charters/P11_DELIVERY_README.md")
DEMO_SCRIPT = Path("scripts/demos/p11_mnemo.sh")
THIS_FILE = Path("tests/acceptance/p11_mnemo/test_memory_influences_planner_output.py")
