"""Acceptance scaffold for P07 (p07_echo).
...
PROJECT_ID = "P07"
PROJECT_KEY = "p07_echo"
CI_CHECK = "p07-echo-voice"
CHARTER = Path("CAPSTONE/project_charters/P07_echo_voice_first_interaction_layer.md")
DELIVERY_README = Path("CAPSTONE/project_charters/P07_DELIVERY_README.md")
DEMO_SCRIPT = Path("scripts/demos/p07_echo.sh")
THIS_FILE = Path("tests/acceptance/p07_echo/test_voice_command_roundtrip.py")
