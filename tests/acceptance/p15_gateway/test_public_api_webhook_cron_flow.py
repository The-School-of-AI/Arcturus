"""Acceptance scaffold for P15 (p15_gateway).
...
DELIVERY_README = Path("CAPSTONE/project_charters/P15_DELIVERY_README.md")
DEMO_SCRIPT = Path("scripts/demos/p15_gateway.sh")
THIS_FILE = Path("tests/acceptance/p15_gateway/test_public_api_webhook_cron_flow.py")
