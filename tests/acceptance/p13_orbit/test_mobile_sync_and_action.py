"""Acceptance scaffold for P13 (p13_orbit).
...
DEMO_SCRIPT = Path("scripts/demos/p13_orbit.sh")
THIS_FILE = Path("tests/acceptance/p13_orbit/test_mobile_sync_and_action.py")
