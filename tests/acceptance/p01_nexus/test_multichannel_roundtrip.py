"""Acceptance scaffold for P01 (p01_nexus).
...
DELIVERY_README = Path("CAPSTONE/project_charters/P01_DELIVERY_README.md")
DEMO_SCRIPT = Path("scripts/demos/p01_nexus.sh")
THIS_FILE = Path("tests/acceptance/p01_nexus/test_multichannel_roundtrip.py")
