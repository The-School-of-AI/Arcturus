"""Integration scaffold for P09 (p09_bazaar).
...
ACCEPTANCE_FILE = Path("tests/acceptance/p09_bazaar/test_tampered_skill_is_blocked.py")
INTEGRATION_FILE = Path("tests/integration/test_bazaar_skill_install_execution.py")
