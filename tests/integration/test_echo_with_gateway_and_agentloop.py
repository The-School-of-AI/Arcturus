"""Integration scaffold for P07 (p07_echo).
...
ACCEPTANCE_FILE = Path("tests/acceptance/p07_echo/test_voice_command_roundtrip.py")
INTEGRATION_FILE = Path("tests/integration/test_echo_with_gateway_and_agentloop.py")
